...
if __name__ == "__main__":
    ...
    video_info = sv.VideoInfo.from_video_path("data/vehicles.mp4")
    ...
    frame_generator = sv.get_video_frames_generator("data/vehicles.mp4")
    ...
    for frame in frame_generator:
        ...
        if out is None:
            ...
            out = cv2.VideoWriter('data/output/output_video.mp4', fourcc, 20.0, (width, height))
